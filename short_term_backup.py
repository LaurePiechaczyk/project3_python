...
def check_guess(choice,boats_position,touched_boats_position,missed_boats_position,score):
    if choice in boats_position:
        print("A ship has been touched")
        score += 1
        print(score)
        touched_boats_position.append(choice)
        return score
    else:
        print("ships have been missed this time")
        missed_boats_position.append(choice)
        score = score
        return score

def one_run():
    player.score = check_guess(make_guess(),computer.boats_position,computer.touched_boats_position,player.missed_boats_position,player.score)
    computer.score = check_guess(computer_guess(),player.boats_position,player.touched_boats_position,computer.missed_boats_position,computer.score)
    print()
    print(computer.touched_boats_position)
    print(player.touched_boats_position)
    print(player.score)


    print("-" * 35)
    print(f'after this round the score is:\n{name}:{player.score} \nComputer:{computer.score} ')
    print("-" * 35)
